...
func parseFlags() config {
	...
	flag.StringVar(&reversePolicy, "reverse-policy", "", "Enable reverse trusses: ttl, probability, inverse_depth, depth_linear, depth_quadratic, depth_cubic, depth_ratio, or experimental upstream_pressure")
