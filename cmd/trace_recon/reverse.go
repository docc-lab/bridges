...
func parseReverseConfig(c config, policy string, p float64, ttl string, seed uint64, q float64) (*bridge.ReverseConfig, error) {
	...
	rc := &bridge.ReverseConfig{Policy: policy, LeafRejectProbability: q, TTLMin: lo, TTLMax: hi, Seed: seed}
