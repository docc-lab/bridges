#!/usr/bin/env bash
# Run a detached-worker slice of the canonical first-100k Day-1 matrix.
# Usage: run_first100k_recon_matrix.sh WORKER_LABEL CPD [CPD ...]
set -u
...
out_dir="$repo_dir/output/reconstruction_matrix_first100k_prime_up_ha_safe"
