#!/bin/bash
# 50k day-1 traces, re-run of policy_probe_20260924 with --pressure-service-depths.
# Question: is reverse-checkpoint load concentrating on particular SERVICES at
# particular depths, and does passing scheduled checkpoints relieve or worsen it?
# Identical to that probe in every other flag, so the two are comparable.
ROOT=/mydata/uber/instdepth_probe_20260924
